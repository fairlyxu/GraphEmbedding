...
def parse_args():
    ...
    parser.add_argument("--features_label_file", type=str, default='../output/features_label.pkl')
    parser.add_argument("--model_out_dir", type=str, default='../output/EGES/checkpoints/EGES')
...
if __name__ == "__main__":
    ...
    len_item = 200000
    feature_lens = [len_item, 150, 10, 5]
    ...
    values = {'d_st_2_did': 0, 'd_st_cat3': 'other', 'd_st_from_type': -1, 'd_st_offer': 0}
    ...
    item['d_st_from_type'] = item['d_st_from_type'].astype(np.int)
    item['d_st_offer'] = item['d_st_offer'].astype(np.int)


    item_df = item[item_feat_name]
    item_df['d_st_2_did'] = item_df['d_st_2_did'].fillna(0)
    item_df['d_st_cat3'] = item_df['d_st_cat3'].fillna('other')
    item_df['d_st_from_type'] = item_df['d_st_from_type'].fillna(-1)
